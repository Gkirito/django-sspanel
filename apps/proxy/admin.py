...
class ProxyNodeAdmin(admin.ModelAdmin):
    ...
    all_inlines = [SSConfigInline, RelayRuleInline, TrojanConfigInline]
...
class TrojanConfigAdmin(admin.ModelAdmin):
    list_display = [
        "proxy_node"
    ]
    formfield_overrides = {
...
admin.site.register(models.TrojanConfig, TrojanConfigAdmin)
